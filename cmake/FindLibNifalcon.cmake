...
set(_deps_check)
if(NOT WIN32)
	find_library(LIBNIFALCON_LIBUSB1_LIBRARY
	...
	find_library(LIBNIFALCON_rt_LIBRARY
		NAMES rt)
	set(_deps_check
...
if(LIBNIFALCON_FOUND)
	...
	if(NOT WIN32)
		list(APPEND LIBNIFALCON_LIBRARIES "${LIBNIFALCON_LIBUSB1_LIBRARY}" "${LIBNIFALCON_rt_LIBRARY}")
