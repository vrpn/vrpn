...
static char rcsid[] = 
"$Id: quat.c,v 1.1 1997/07/25 16:44:11 chenju Exp $";
 ...
 *****************************************************************************/
void 
q_to_vec(q_vec_type	 destVec, q_vec_type	srcQuat)
{
 ...
 *****************************************************************************/
void 
qp_to_matrix( Q_MatrixType	destMatrix, q_type  srcQuat)
 ...
 *****************************************************************************/
void 
q_to_row_matrix(q_matrix_type destMatrix, q_type srcQuat)
{
    double  s;
    double  xs, ys, zs,
    	    wx, wy, wz,
 ...
 *****************************************************************************/
void 
q_to_col_matrix(q_matrix_type destMatrix,q_type srcQuat)
...
void 
qp_from_matrix(q_type destQuat, Q_MatrixType srcMatrix)
...
void 
q_from_col_matrix(q_type destQuat,q_matrix_type srcMatrix)
...
void 
q_from_row_matrix(q_type destQuat, q_matrix_type srcMatrix)
...
void
qgl_to_matrix(qgl_matrix_type destMatrix, q_type srcQuat)
...
void 
qgl_from_matrix(q_type destQuat,qgl_matrix_type srcMatrix)
{
    double  	trace, s;
    int     	i, j, k;
    static int 	next[3] = {Y, Z, X};
 ...
 *****************************************************************************/
void
q_from_ogl_matrix( q_type destQuat, qogl_matrix_type matrix )
{
    double     trace, s;
    int        i, j, k;
    static int next[3] = { Y, Z, X };
 ...
 *****************************************************************************/
void 
q_to_ogl_matrix(qogl_matrix_type matrix,q_type srcQuat )
{
    double s;
