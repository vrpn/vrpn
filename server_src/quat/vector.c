...
/*****************************************************************************
 *
   q_set_vec - set vector equal to 3 values given
 *
 *****************************************************************************/

void
q_set_vec(q_vec_type vec, double x, double y, double z)
...
void
q_vec_copy(q_vec_type destVec, q_vec_type srcVec)
{
...
void
q_vec_add(q_vec_type destVec, q_vec_type aVec,q_vec_type bVec)
{
    int	    i;
...
void
q_vec_subtract(q_vec_type	 destVec,q_vec_type	 v1,q_vec_type	 v2)
...
double
q_vec_dot_product( q_vec_type v1, q_vec_type v2)
{
...
void
q_vec_scale(q_vec_type destVec, double scaleFactor, q_vec_type
			srcVec)
...
void
q_vec_invert(q_vec_type destVec, q_vec_type srcVec)
...
double
q_vec_magnitude(q_vec_type vec)
{
...
void
q_vec_normalize(q_vec_type destVec, q_vec_type srcVec)
...
double
q_vec_distance(q_vec_type vec1, q_vec_type vec2)
...
void
q_vec_cross_product(q_vec_type	destVec,q_vec_type aVec,q_vec_type bVec)
...
/*****************************************************************************
 *
   qp_vec_copy- copy PPHIGS srcVec to PPHIGS destVec
 *
 *****************************************************************************/

void 
qp_vec_copy(Q_VectorType destVec, Q_VectorType srcVec)
...
/*****************************************************************************
 *
   qp_pvec_to_vec- convert PPHIGS srcVec to quatlib destVec
 *
 *****************************************************************************/

void 
qp_pvec_to_vec(q_vec_type destVec,  Q_VectorType srcVec)
 
{

destVec[Q_X] = srcVec[X];
destVec[Q_Y] = srcVec[Y];
destVec[Q_Z] = srcVec[Z];
...
/*****************************************************************************
 *
   qp_vec_to_pvec- convert quatlib srcVec to PPHIGS destVec
 *
 *****************************************************************************/

void 
qp_vec_to_pvec( Q_VectorType destVec, q_vec_type srcVec)
{

destVec[X] = srcVec[Q_X];
destVec[Y] = srcVec[Q_Y];
destVec[Z] = srcVec[Q_Z];
