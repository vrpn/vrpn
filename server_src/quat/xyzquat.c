...
void
q_row_matrix_to_xyz_quat(q_xyz_quat_type *xyzQuatPtr,q_matrix_type rowMatrix)
{
    int	    i;
...
void
q_ogl_matrix_to_xyz_quat( q_xyz_quat_type *xyzQuatPtr, qogl_matrix_type matrix )
...
void
qp_pmatrix_to_xyz_quat(q_xyz_quat_type 	*xyzQuatPtr, Q_MatrixType pMatrix)
...
void
qp_xyz_quat_to_pmatrix(Q_MatrixType  pMatrix, q_xyz_quat_type 	*xyzQuatPtr)
...
void
q_xyz_quat_compose(q_xyz_quat_type *C_from_A_ptr, q_xyz_quat_type *C_from_B_ptr, q_xyz_quat_type *B_from_A_ptr)
{
