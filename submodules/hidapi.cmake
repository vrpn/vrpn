...
if(VRPN_USE_LOCAL_HIDAPI)
	...
	elseif(WIN32)
		...
		elseif(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/hidapi/windows/hid.c")
			...
			message(STATUS "ERROR: Can't use local HIDAPI - can't find the source file!  Perhaps an unknown upstream version?")
	...
	elseif(VRPN_HIDAPI_USE_LIBUSB)
		if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/hidapi/libusb/hid.c")
			...
			list(APPEND HIDAPI_SOURCES "${CMAKE_CURRENT_SOURCE_DIR}/hidapi/libusb/hid.c")
