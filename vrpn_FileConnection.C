...
vrpn_File_Connection::vrpn_File_Connection (const char * file_name,
    ...
    d_set_replay_rate_type(
        register_message_type("vrpn_File_set_replay_rate")),
    d_reset_type (register_message_type("vrpn_File_reset")),
    d_play_to_time_type (register_message_type("vrpn_File_play_to_time")),
    d_file (NULL),
    d_fileName (NULL),
    d_logHead (NULL),
    d_logTail (NULL),
