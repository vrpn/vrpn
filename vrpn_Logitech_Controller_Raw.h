...
// Device drivers for the Logitech Controller Raw USB line of products
// Currently supported: Extreme 3D Pro
//
...
class vrpn_Logitech_Controller_Raw: public vrpn_BaseClass, protected vrpn_HidInterface {
public:
	vrpn_Logitech_Controller_Raw(vrpn_HidAcceptor *filter, const char *name,
...
class vrpn_Logitech_Extreme_3D_Pro: protected vrpn_Logitech_Controller_Raw, public vrpn_Analog, public vrpn_Button_Filter, public vrpn_Dial
{
public:
...
// end of VRPN_USE_HID
#else
class VRPN_API vrpn_Logitech_Extreme_3D_Pro;
#endif
