/** @file
	@brief Header containing macros formerly duplicated in a lot of implementation files.
	...
	new way of simplifying message sending is in vrpn_SendTextMessageStreamProxy.h. 
