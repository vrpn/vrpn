...
protected:
    ...
    virtual static vrpn_int32 handle_reset (void *, vrpn_HANDLERPARAM) = 0;
    virtual static vrpn_int32 handle_play_to_time (void *, vrpn_HANDLERPARAM) = 0;
...
// of vrpn_FileConnection_ControllerInterface. It is completely different 
// from the previous incarnation of vrpn_FileController
//=============================================================================
class vrpn_FileController 
{
private: // data members

    static vrpn_FileController * sp_pfc;  // initialized elsewhere
    vrpn_FileConnection_ControllerInterface * p_pfcci;

public: // c'tors and init
    vrpn_FileController( vrpn_FileConnection * pfc );

    static FileController *
    get_FileController( vrpn_ClientConnectionController * pccc );
