...
/** @brief Device supporting the Razer Hydra game controller as a tracker,
	...
	* 6 - joystick button (if you push straight down on the joystick)
	...
	instead of 0:
	* 0 - joystick left/right: centered at 0, right is positive
	* 1 - joystick up/down: centered at 0, up is positive
	* 2 - analog trigger, theoretically from 0 (not pressed) to 255 (fully
		pressed) but generally making it up to only about 240-250.
*/
