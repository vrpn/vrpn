...
// XXX This is not the standard android definition (if there is one); it needs to be
// defined in the makefile.  Also, it would be nice not to pull all these files in
// right here, but rather where they are needed.	
#ifdef __ANDROID__
#include <unistd.h>
#endif
